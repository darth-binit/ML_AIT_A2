This is new project where we have developed new custom Regression Model as `Model A2`. This is a continuation to our first Model A1. The dataset are all the same, 
